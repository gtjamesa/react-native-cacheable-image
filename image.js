...
import {ActivityIndicator, Image, NetInfo, Platform} from 'react-native';
...
export default class CacheableImage extends React.Component {
    ...
    checkImageCache = (imageUri, cachePath, cacheKey) => {
        ...
        // then make sure directory exists...
    ...
    renderCache() {
        ...
        return (
            <ResponsiveImage {...props} source={{uri: 'file://' + this.state.cachedImagePath}}
                             ref={component => this._imageComponent = component}>
                {children}
            </ResponsiveImage>
        );
    }
    ...
    renderDefaultSource() {
        ...
        return (
            <CacheableImage {...props} source={defaultSource} checkNetwork={false}
